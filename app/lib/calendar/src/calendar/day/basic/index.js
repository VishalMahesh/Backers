...
export default class BasicDay extends Component {
  ...
  renderText() {
    ...
    return (
      <View style={[{
        width: wide * 0.1, height: wide * 0.1, borderWidth: 0.5,
        borderColor: selected ? Colors.base : Colors.shade,
        borderRadius: 2, backgroundColor: this.isDisabled() ? Colors.lightbase : "transparent"
      }, CommonStyles.center]}>
        <Label
          label={String(this.props.children)}
